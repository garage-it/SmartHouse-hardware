...
void callback(char* topic, byte* payload, unsigned int length) {
  ...
  if (strTopic == "/smart-home/in/RELAY_4") {
    if (strPayload == "OFF")     {
  ...
  //      delay(500);
  //    }
  //    else if (strPayload == "RELAY_4")  {
  //      client.publish("/smart-home/out/RELAY_4", "{\n \"type\": \"relay\", \n \"metrics\": \"switcher\" \n }");
  //      Serial.println("{\n \"type\": \"relay\", \n \"metrics\": \"switcher\" \n }");
  //      delay(500);
  //    }
...
void loop() {
  ...
  if (millis() > (lastMqtt + 10000)) {
    ...
    if (client.connected()) {
      ...
      if (digitalRead(RELAY_4)) client.publish("/smart-home/out/RELAY_4", "ON");
      else client.publish("/smart-home/out/RELAY_4", "OFF");
